...
public final class CheckoutPage extends BasePage {
    ...
    public void fillTestingDetails() {
        Steps.step(Steps.Actions.CHECKOUT_FILL, () -> {
    ...
    public int submitOrder() {
        return Steps.stepReturning(Steps.Actions.CHECKOUT_SUBMIT, () -> {
            ...
            if (!match.find()) {
                throw new AssertionError("Order ID was not present in the order detail URL");
            }
